...
export const metadata: Metadata = {
  title: 'Expert Roofing Services North Myrtle Beach SC | Weather Shield Roofing - 5.0★',
  description: "North Myrtle Beach's #1 roofing contractor with 5.0★ rating. Expert roof replacement, repair & storm damage services. GAF Certified. 24/7 emergency service. Call (843) 877-5539",
  keywords: 'roofing north myrtle beach, north myrtle beach roofing, roofing contractor north myrtle beach sc, roof replacement north myrtle beach, roof repair north myrtle beach, storm damage north myrtle beach',
  alternates: {
    canonical: 'https://weathershieldroofers.com/roofing/north-myrtle-beach',
  },
  openGraph: {
    title: "Expert Roofing Services North Myrtle Beach SC | Weather Shield Roofing - 5.0★",
    description: "North Myrtle Beach's #1 roofing contractor. GAF Certified • 24/7 Emergency Service • Lifetime Warranties",
    url: 'https://weathershieldroofers.com/roofing/north-myrtle-beach',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Professional Roofing Services in North Myrtle Beach, SC - Weather Shield Roofing',
      }
    ],
    locale: 'en_US',
    type: 'website',
...
export default function NorthMyrtleBeachRoofingPage() {
  return (
    <>
      {/* Schema Markup */}
      <script
            ...
            "@graph": [
              {
                ...
                "name": "Weather Shield Roofing - North Myrtle Beach",
              ...
              },
              {
                ...
                "mainEntity": [
                  {
                    "@type": "Question",
                    "name": "How much does roof replacement cost in North Myrtle Beach?",
                    "acceptedAnswer": {
                      "@type": "Answer",
                  ...
                  {
                    "@type": "Question",
                    "name": "What's the best roofing material for North Myrtle Beach's coastal climate?",
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "For North Myrtle Beach's coastal climate, we recommend GAF architectural shingles or metal roofing. Both offer excellent hurricane wind resistance, salt air protection, and UV resistance. Our team can help you choose the best material for your specific needs and budget."
                    }
                  },
                  {
                    "@type": "Question",
                    "name": "Do you handle insurance claims for storm damage in North Myrtle Beach?",
                    "acceptedAnswer": {
                      "@type": "Answer",
                  ...
                  {
                    "@type": "Question",
                    "name": "Do you offer 24/7 emergency roofing services in North Myrtle Beach?",
                    "acceptedAnswer": {
                      "@type": "Answer",
              ...
              },
              {
                ...
                "itemListElement": [
                  ...
                  },
                  {
                    "@type": "ListItem",
                    "position": 3,
                    "name": "North Myrtle Beach Roofing",
                    "item": "https://weathershieldroofers.com/roofing/north-myrtle-beach"
                  }
                ]
              }
            ]
      ...
      <main className="min-h-screen">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-6">
                ...
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
                  North Myrtle Beach's #1 Rated Roofing Contractor
                </h1>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
              ...
              <div>
                ...
                <div className="text-sm text-gray-600">In North Myrtle Beach</div>
              </div>
              <div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                ...
                <h2 className="text-4xl md:text-5xl font-bold text-gray-900">
                  North Myrtle Beach's Trusted Roofing Partner Since 2010
                </h2>
                <div className="prose prose-lg text-gray-600">
                  <p>
                    For over 15 years, Weather Shield Roofing has been protecting homes and businesses throughout North Myrtle Beach and the Carolina Coast with expert craftsmanship and exceptional service.
                  </p>
                  <p>
                    As a locally-owned and operated company, we understand the unique challenges that North Myrtle Beach's coastal climate presents. From hurricane season to intense summer heat, humidity, and salt air exposure, your roof faces constant stress.
                  </p>
                  <p>
              ...
              <div className="relative">
                <div className="aspect-[4/3] relative rounded-2xl overflow-hidden shadow-2xl">
                  <Image
                    ...
                    alt="Weather Shield Roofing professional team in North Myrtle Beach"
                    fill
                ...
                <div className="absolute -bottom-6 -right-6 bg-blue-900 text-white p-8 rounded-xl shadow-xl">
                  ...
                  <div className="text-sm">Years Serving<br/>North Myrtle Beach</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
                Complete Roofing Services for North Myrtle Beach
              </h2>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                },
                {
                  ...
                  description: 'Flat roofs, TPO, EPDM systems for businesses throughout North Myrtle Beach.',
                  icon: '🏢',
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-4xl md:text-5xl font-bold mb-4">
                Why North Myrtle Beach Homeowners Choose Weather Shield
              </h2>
              ...
              {[
                {
                  ...
                  description: 'Only roofing company in North Myrtle Beach with a perfect 5.0-star rating on Google (73 reviews).'
                },
                {
                  icon: '🏆',
                ...
                },
                {
                  ...
                  description: 'Deep understanding of salt air, humidity, hurricanes, and UV exposure unique to North Myrtle Beach.'
                },
                {
                  icon: '⚡',
                ...
                },
                {
                  ...
                  description: 'Serving North Myrtle Beach since 2010. Over 2,000 satisfied customers and counting.'
                },
                {
                  icon: '✅',
                  title: 'BBB A+ Rating',
        ...
        <section className="py-16 md:py-24 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
                Built for North Myrtle Beach's Coastal Climate
              </h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
        ...
        <section className="py-16 md:py-24 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
                Serving All North Myrtle Beach Neighborhoods
              </h2>
              <p className="text-xl text-gray-600">
                From Cherry Grove to Little River, we protect homes throughout North Myrtle Beach.
              </p>
            </div>

            <div className="grid md:grid-cols-3 lg:grid-cols-5 gap-4">
              {[
                { name: 'Cherry Grove', link: '/locations/cherry-grove' },
                { name: 'Ocean Drive', link: '/locations/north-myrtle-beach' },
                { name: 'Crescent Beach', link: '/locations/crescent-beach' },
                { name: 'Windy Hill', link: '/locations/windy-hill' },
                { name: 'Barefoot Resort', link: '/locations/barefoot-resort' },
                { name: 'North Beach Plantation', link: '/locations/north-beach-plantation' },
                { name: 'Little River', link: '/locations/little-river' },
                { name: 'Longs', link: '/locations/longs' },
                { name: 'Tilghman Estates', link: '/locations/north-myrtle-beach' },
                { name: 'Atlantic Beach', link: '/locations/atlantic-beach-sc' }
        ...
        <section className="py-16 md:py-24 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
                What North Myrtle Beach Homeowners Say
              </h2>
              <p className="text-xl text-gray-600">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                {
                  name: 'Sarah B.',
                  location: 'Cherry Grove, North Myrtle Beach',
                  review: 'Weather Shield replaced our roof after hurricane damage. They were professional, responsive, and handled all the insurance paperwork. Our new roof looks beautiful and we have complete peace of mind.',
                  rating: 5
                },
                {
                  name: 'Tom H.',
                  location: 'Barefoot Resort, North Myrtle Beach',
                  review: 'Best roofing company in North Myrtle Beach! From the initial inspection to final cleanup, everything was handled perfectly. The GAF warranty gives us confidence for years to come.',
                  rating: 5
                },
                {
                  name: 'Jennifer M.',
                  location: 'Little River, North Myrtle Beach',
                  review: 'Living near the ocean requires special roofing expertise. Weather Shield installed a metal roof that withstands salt air and high winds. Worth every penny for the quality and durability.',
                  rating: 5
                }
            ...
            <div className="text-center mt-8">
              <a href="https://www.google.com/search?q=weather+shield+roofing+north+myrtle+beach" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-700 font-semibold">
            ...
            <div className="grid lg:grid-cols-2 gap-12">
              <div>
                <h2 className="text-4xl md:text-5xl font-bold mb-6">
                  Understanding North Myrtle Beach's Unique Roofing Challenges
                </h2>
                <p className="text-xl text-blue-100 mb-8">
                  North Myrtle Beach's coastal climate presents unique challenges that require specialized knowledge and materials.
                </p>
              </div>
              <div className="space-y-6">
                {[
        ...
        <section className="py-16 md:py-24 bg-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600">
                Answers to common questions about roofing in North Myrtle Beach
              </p>
            </div>
            ...
            <div className="space-y-6">
              {[
                {
                  question: 'How much does roof replacement cost in North Myrtle Beach?',
                ...
                {
                  question: "What's the best roofing material for North Myrtle Beach's coastal climate?",
                  answer: "For North Myrtle Beach's coastal climate, we recommend GAF architectural shingles or metal roofing. Both offer excellent hurricane wind resistance, salt air protection, and UV resistance. Our team can help you choose the best material for your specific needs and budget."
                },
                {
                  question: 'How long does a roof last in North Myrtle Beach?',
                  answer: 'With proper installation and maintenance, architectural shingles typically last 25-30 years in North Myrtle Beach, while metal roofs can last 50+ years. Coastal conditions require regular inspections to maximize lifespan.'
                },
                {
                ...
                {
                  question: 'What areas of North Myrtle Beach do you serve?',
                  answer: 'We serve all of North Myrtle Beach including Cherry Grove, Ocean Drive, Crescent Beach, Windy Hill, Barefoot Resort, North Beach Plantation, Little River, and all surrounding coastal communities.'
                }
              ].map((faq, index) => (
        ...
        <section className="py-16 md:py-24 bg-gradient-to-br from-blue-900 via-blue-800 to-blue-900 text-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              Ready to Protect Your North Myrtle Beach Home?
            </h2>
            <p className="text-xl text-blue-100 mb-8">
              Join 2,000+ North Myrtle Beach homeowners who chose quality, reliability, and peace of mind with Weather Shield Roofing.
            </p>
