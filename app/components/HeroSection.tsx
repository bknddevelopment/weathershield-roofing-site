                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <ul className="space-y-3">
                      ...
                      <li className="flex items-start gap-3 group hover:translate-x-1 transition-transform">
                        <CheckCircle className="w-6 h-6 text-weather-teal mt-0.5 flex-shrink-0 group-hover:text-weather-blue transition-colors" />
                        <span className="text-gray-100 group-hover:text-white transition-colors">Lifetime Workmanship Warranty</span>
                      </li>
                      <li className="flex items-start gap-3 group hover:translate-x-1 transition-transform">
                        <CheckCircle className="w-6 h-6 text-weather-teal mt-0.5 flex-shrink-0 group-hover:text-weather-blue transition-colors" />
                        <span className="text-gray-100 group-hover:text-white transition-colors">Insurance Claim Specialists</span>
                      </li>
                      <li className="flex items-start gap-3 group hover:translate-x-1 transition-transform">
                        <CheckCircle className="w-6 h-6 text-weather-teal mt-0.5 flex-shrink-0 group-hover:text-weather-blue transition-colors" />
