...
export const metadata: Metadata = {
  title: '24/7 Emergency Roof Repair North Beach Plantation SC | 60-Acre Oceanfront Resort Community | WeatherShield',
  description: 'Emergency roof repair North Beach Plantation SC for luxury homes. Hurricane damage, storm leaks, premium material emergency repair. Resort property specialists. Call (843) 877-5539 NOW!',
  keywords: 'emergency roof repair North Beach Plantation, luxury roofing North Myrtle Beach, premium emergency roofing, hurricane damage North Beach Plantation, North Myrtle Beach emergency roofing',
}

export default function EmergencyRoofingNorthBeachPlantationPage() {
  return (
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-6xl font-black text-white mb-6 leading-tight drop-shadow-2xl">
              ...
              <span className="block text-3xl md:text-5xl mt-2 text-yellow-300">
                North Beach Plantation, SC
              </span>
            </h1>

            <p className="text-xl md:text-2xl text-white mb-8">
              Multi-Family • High-Rise • Townhome Emergency Repairs<br />
              60-Acre Oceanfront Resort Community Specialists Available Now
            </p>
            ...
            <div className="mt-8 pt-8 border-t border-white/20">
              <p className="text-white/90 text-lg font-medium">
                ⚡ North Beach Plantation Emergency Roofing • Licensed & Insured •
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold mb-8 text-center">
              North Beach Plantation Luxury Home Emergency Roofing
            </h2>
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-12">
              <div className="bg-white rounded-xl shadow-lg p-6">
                ...
                <p className="text-gray-700 mb-4">
                  North Beach Plantation's oceanfront resort properties require large-scale emergency coordination. We specialize in HOA emergency services for towers, townhomes, and villas.
                </p>
              ...
              <div className="bg-white rounded-xl shadow-lg p-6">
                ...
                <p className="text-gray-700 mb-4">
                  North Beach Plantation homes require specialized hurricane damage repair. We restore premium systems to original condition using luxury materials rated for coastal storms.
                </p>
                <ul className="space-y-2 text-sm text-gray-600">
              ...
              <div className="bg-white rounded-xl shadow-lg p-6">
                ...
                <p className="text-gray-700 mb-4">
                  We understand the value of North Beach Plantation properties. Emergency crews respond rapidly with premium materials and expert craftsmanship to protect your investment.
                </p>
                <ul className="space-y-2 text-sm text-gray-600">
            ...
            <div className="bg-gradient-to-r from-weather-teal to-weather-blue rounded-xl p-8 text-white mb-12">
              <h3 className="text-2xl font-bold mb-6 text-center">
                Why North Beach Plantation Homeowners Trust WeatherShield
              </h3>
              <div className="grid md:grid-cols-3 gap-6">
                <div>
                  <h4 className="font-bold mb-2">🏆 Luxury Home Specialists</h4>
                  <p className="text-sm text-white/90">
                    15+ years experience with North Beach Plantation's premium properties and high-end roofing materials.
                  </p>
                </div>
                <div>
            ...
            <div className="bg-gray-900 rounded-xl p-8 text-center text-white">
              <h3 className="text-2xl md:text-3xl font-bold mb-4">
                Protect Your North Beach Plantation Investment - Call NOW
              </h3>
              ...
              <p className="mt-4 text-white/80 text-sm">
                24/7 Service • Licensed & Insured • North Beach Plantation Specialists
              </p>
            </div>
            ...
            <div className="mt-8 text-center">
              <Link
                href="/locations/north-beach-plantation"
                className="text-weather-teal hover:text-weather-blue font-semibold"
              >
                ← Learn more about our North Beach Plantation roofing services
              </Link>
            </div>
          </div>
        </div>
