...
export const metadata: Metadata = {
  title: '24/7 Roof Replacement Kiawah Island SC | WeatherShield Roofing',
  description: 'Roof Replacement Kiawah Island SC. New roofs, hurricane-resistant systems, premium materials. Licensed roofing contractor. Call (843) 877-5539 now.',
  keywords: 'roof replacement Kiawah Island, luxury estate roofing Kiawah, premium roofing Kiawah Island SC',
}

export default function RoofReplacementKiawahIslandPage() {
  return (
      ...
      <section className="py-16 px-4 bg-gray-800">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-white text-center mb-12">
            Kiawah Island Roof Replacement Services
          </h2>
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-gray-900 p-6 rounded-lg border-l-4 border-red-500">
              <h3 className="text-xl font-bold text-white mb-3">🏆 Estate-Grade Roof Systems</h3>
              <p className="text-gray-300">
                Complete luxury roof replacements with 160+ mph wind ratings, designer materials, custom copper work, and architectural excellence for Kiawah's premier properties.
              </p>
            </div>
            <div className="bg-gray-900 p-6 rounded-lg border-l-4 border-red-500">
              <h3 className="text-xl font-bold text-white mb-3">🌀 Hurricane Engineering Excellence</h3>
              <p className="text-gray-300">
                Advanced structural reinforcement, impact-resistant materials, and sealed construction methods that protect multi-million dollar Kiawah investments through Atlantic storms.
              </p>
            </div>
            <div className="bg-gray-900 p-6 rounded-lg border-l-4 border-red-500">
              <h3 className="text-xl font-bold text-white mb-3">🏛️ ARB-Approved Premium Materials</h3>
              <p className="text-gray-300">
                Expert navigation of Kiawah ARB processes with premium shingles, slate alternatives, and custom details that exceed resort community expectations.
              </p>
            </div>
            <div className="bg-gray-900 p-6 rounded-lg border-l-4 border-red-500">
              <h3 className="text-xl font-bold text-white mb-3">🌊 Marine-Grade Construction</h3>
              <p className="text-gray-300">
                Oceanfront estate roofing with stainless steel fasteners, custom copper flashing, and corrosion-resistant systems engineered for extreme saltwater conditions.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-300">
                  Full roof replacement services for Kiawah homes with premium materials, expert installation, and comprehensive warranties.
                </p>
              </div>
            </div>
            <div className="flex items-start gap-4">
      ...
      <section className="py-16 px-4 bg-red-600">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-5xl font-black text-white mb-6">
            NEED A NEW ROOF ON KIAWAH ISLAND?
          </h2>
          ...
          <p className="text-white mt-6 text-lg">
            Serving Ocean Course, Turtle Point, Osprey Point, East Beach Village & all Kiawah estates
          </p>
        </div>
      </section>
