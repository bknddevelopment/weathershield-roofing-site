...
export const metadata: Metadata = {
  ...
  description: 'Affordable roof financing in Myrtle Beach SC. 0% APR available, zero down payment options, bad credit financing welcome. Quick approval in minutes. Payment plans for all credit types. Call (843) 293-8150.',
  ...
  openGraph: {
    ...
    description: '100% financing available! Zero down payment options. Bad credit welcome. Quick approval. 0% APR plans available. Call (843) 293-8150 for instant approval.',
