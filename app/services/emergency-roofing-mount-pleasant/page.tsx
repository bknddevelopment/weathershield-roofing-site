...
export const metadata: Metadata = {
  title: '24/7 Emergency Roof Repair Mount Pleasant SC | WeatherShield Roofing',
  description: 'Emergency Roof Repair Mount Pleasant SC. 24/7 storm damage, hurricane leaks, wind damage. Licensed roofing contractor. Call (843) 877-5539 now.',
  keywords: 'emergency roof repair Mount Pleasant, 24/7 roofing Mount Pleasant SC, storm damage repair Mount Pleasant',
}

export default function EmergencyRoofingMountPleasantPage() {
  return (
      ...
      <section className="py-16 px-4 bg-gray-800">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-white text-center mb-12">
            Mount Pleasant Emergency Roofing Services
          </h2>
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-gray-900 p-6 rounded-lg border-l-4 border-red-500">
              <h3 className="text-xl font-bold text-white mb-3">🌀 Hurricane Emergency Services</h3>
              <p className="text-gray-300">
                Mount Pleasant's coastal proximity creates hurricane threats. We provide immediate response for wind damage, water intrusion, and structural compromise.
              </p>
            </div>
            <div className="bg-gray-900 p-6 rounded-lg border-l-4 border-red-500">
              <h3 className="text-xl font-bold text-white mb-3">💨 Severe Weather Damage Repair</h3>
              <p className="text-gray-300">
                Spring and summer storms bring damaging winds and hail. Our emergency crews respond fast with tarping, leak repair, and comprehensive damage mitigation.
              </p>
            </div>
            <div className="bg-gray-900 p-6 rounded-lg border-l-4 border-red-500">
              <h3 className="text-xl font-bold text-white mb-3">🏘️ Community Emergency Response</h3>
              <p className="text-gray-300">
                From historic Old Village to modern Park West, we understand Mount Pleasant neighborhoods. Fast emergency response with materials that match your community standards.
              </p>
            </div>
            <div className="bg-gray-900 p-6 rounded-lg border-l-4 border-red-500">
              <h3 className="text-xl font-bold text-white mb-3">🛡️ Insurance Claim Emergency Service</h3>
              <p className="text-gray-300">
                We document damage, provide emergency protection, and work with your insurance company to ensure fair compensation for storm-related roof damage.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-300">
                  Available around the clock for Mount Pleasant roofing emergencies. We respond immediately to storm damage, leaks, and urgent repairs.
                </p>
              </div>
            </div>
            <div className="flex items-start gap-4">
      ...
      <section className="py-16 px-4 bg-red-600">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-5xl font-black text-white mb-6">
            ROOF EMERGENCY ON MOUNT PLEASANT?
          </h2>
          ...
          <p className="text-white mt-6 text-lg">
            Serving Old Village, Park West, Belle Hall, Carolina Park & all Mount Pleasant areas
          </p>
        </div>
      </section>
