...
export const metadata: Metadata = {
  ...
  keywords: 'roofing FAQ, Myrtle Beach roofing questions, roof replacement cost, roof repair, storm damage, manufacturer warranty, roofing contractor questions, emergency roof repair',
  openGraph: {
