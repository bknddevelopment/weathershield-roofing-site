...
const config: Config = {
  ...
  corePlugins: {
    ...
    borderOpacity: true,
    borderRadius: true,
    borderSpacing: false, // Disabled
    borderStyle: true,
    borderWidth: true,
    boxDecorationBreak: false, // Disabled
    boxShadow: true,
    boxShadowColor: true,
    boxSizing: true,
    breakAfter: false, // Disabled
    breakBefore: false, // Disabled
    breakInside: false, // Disabled
    brightness: true,
    caretColor: false, // Disabled
    clear: true,
    ...
    fontSmoothing: true,
    fontStyle: true,
    fontVariantNumeric: false, // Disabled
    fontWeight: true,
    gap: true,
    ...
    height: true,
    hueRotate: true,
    hyphens: false, // Disabled
    inset: true,
    invert: true,
    isolation: false, // Disabled
    justifyContent: true,
    justifyItems: true,
    justifySelf: true,
    letterSpacing: true,
    lineClamp: true,
    lineHeight: true,
    listStyleImage: false, // Disabled
    listStylePosition: false, // Disabled
    listStyleType: true,
    margin: true,
    maxHeight: true,
    maxWidth: true,
