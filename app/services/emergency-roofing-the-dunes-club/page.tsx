...
export const metadata: Metadata = {
  title: '24/7 Emergency Roof Repair The Dunes Club SC | Historic Golf & Beach Club | WeatherShield',
  description: 'Emergency roof repair The Dunes Club SC for luxury homes. Hurricane damage, storm leaks, premium material emergency repair. Historic estate specialists. Call (843) 877-5539 NOW!',
  keywords: 'emergency roof repair The Dunes Club, luxury roofing Myrtle Beach, premium emergency roofing, hurricane damage The Dunes Club, Myrtle Beach emergency roofing',
}

export default function EmergencyRoofingTheDunesClubPage() {
  return (
        ...
        <div className="relative z-10 container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-white mb-8">
              Slate • Tile • Copper • Heritage Material Emergency Repairs<br />
              Historic Golf & Beach Club Specialists Available Now
            </p>
            ...
            <div className="mt-8 pt-8 border-t border-white/20">
              <p className="text-white/90 text-lg font-medium">
                ⚡ The Dunes Club Emergency Roofing • Licensed & Insured •
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold mb-8 text-center">
              The Dunes Club Luxury Home Emergency Roofing
            </h2>
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-12">
              <div className="bg-white rounded-xl shadow-lg p-6">
                ...
                <p className="text-gray-700 mb-4">
                  The Dunes Club's historic golf and beach estates deserve preservation-focused emergency care. We specialize in heritage roofing repairs that maintain architectural integrity.
                </p>
              ...
              <div className="bg-white rounded-xl shadow-lg p-6">
                ...
                <p className="text-gray-700 mb-4">
                  The Dunes Club homes require specialized hurricane damage repair. We restore premium systems to original condition using luxury materials rated for coastal storms.
                </p>
                <ul className="space-y-2 text-sm text-gray-600">
              ...
              <div className="bg-white rounded-xl shadow-lg p-6">
                ...
                <p className="text-gray-700 mb-4">
                  We understand the value of The Dunes Club properties. Emergency crews respond rapidly with premium materials and expert craftsmanship to protect your investment.
                </p>
                <ul className="space-y-2 text-sm text-gray-600">
            ...
            <div className="bg-gradient-to-r from-weather-teal to-weather-blue rounded-xl p-8 text-white mb-12">
              <h3 className="text-2xl font-bold mb-6 text-center">
                Why The Dunes Club Homeowners Trust WeatherShield
              </h3>
              <div className="grid md:grid-cols-3 gap-6">
                <div>
                  <h4 className="font-bold mb-2">🏆 Luxury Home Specialists</h4>
                  <p className="text-sm text-white/90">
                    15+ years experience with The Dunes Club's premium properties and high-end roofing materials.
                  </p>
                </div>
                <div>
            ...
            <div className="bg-gray-900 rounded-xl p-8 text-center text-white">
              <h3 className="text-2xl md:text-3xl font-bold mb-4">
                Protect Your The Dunes Club Investment - Call NOW
              </h3>
              ...
              <p className="mt-4 text-white/80 text-sm">
                24/7 Service • Licensed & Insured • The Dunes Club Specialists
              </p>
            </div>
            ...
            <div className="mt-8 text-center">
              <Link
                href="/locations/the-dunes-club"
                className="text-weather-teal hover:text-weather-blue font-semibold"
              >
                ← Learn more about our The Dunes Club roofing services
              </Link>
            </div>
          </div>
        </div>
