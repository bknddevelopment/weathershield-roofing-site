...
export const metadata: Metadata = {
  title: 'Expert Roofing Services Cherry Grove SC | Weather Shield Roofing - 5.0★ Rated',
  description: "Cherry Grove's trusted roofing contractor with 5.0★ rating. Expert roof replacement, repair & storm damage services. GAF Certified. 15 miles from Myrtle Beach. Call (843) 877-5539",
  keywords: 'roofing cherry-grove sc, cherry-grove roofing, roofing contractor cherry-grove, roof replacement cherry-grove, roof repair cherry-grove, horry county roofing',
  alternates: {
    canonical: 'https://weathershieldroofers.com/roofing/cherry-grove',
  },
  openGraph: {
    title: "Expert Roofing Services Cherry Grove SC | Weather Shield Roofing - 5.0★",
    description: "Cherry Grove's trusted roofing contractor. GAF Certified • 24/7 Emergency Service • Lifetime Warranties",
    url: 'https://weathershieldroofers.com/roofing/cherry-grove',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Professional Roofing Services in Cherry Grove, SC - Weather Shield Roofing',
      }
    ],
    locale: 'en_US',
    type: 'website',
...
export default function CherryGroveRoofingPage() {
  return (
    <>
      {/* Schema Markup */}
      <script
            ...
            "@graph": [
              {
                ...
                "name": "Weather Shield Roofing - Cherry Grove",
                "image": "https://weathershieldroofers.com/images/logo.png",
                "url": "https://weathershieldroofers.com/roofing/cherry-grove",
                "telephone": "+18438775539",
                "address": {
                  "@type": "PostalAddress",
                  "streetAddress": "Serving Cherry Grove",
                  "addressLocality": "Cherry Grove",
                  "addressRegion": "SC",
                  "postalCode": "29582",
                  "addressCountry": "US"
                },
              ...
              },
              {
                ...
                "mainEntity": [
                  {
                    "@type": "Question",
                    "name": "How does Cherry Grove's inland location affect my roof?",
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "Cherry Grove's inland location (15 miles from the coast) provides significant advantages: no salt air corrosion on metal components, reduced wind speeds during storms, and longer roof lifespan. However, high humidity (74-78%) and heavy summer rainfall (53.7 inches annually) still require proper ventilation and moisture-resistant materials."
                    }
                  },
                  {
                    "@type": "Question",
                    "name": "What roofing challenges are specific to Cherry Grove SC?",
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "Cherry Grove faces unique challenges: enhanced rainfall from sea-breeze front thunderstorms, high humidity creating algae and mold growth, tropical storm remnants bringing heavy rain, and intense summer UV exposure accelerating shingle deterioration. We use materials designed for these specific conditions."
                    }
                  },
                  {
                    "@type": "Question",
                    "name": "Do you serve all Cherry Grove neighborhoods?",
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "Yes! We serve all Cherry Grove areas including Historic Downtown, Riverfront along the Waccamaw River, Carolina Forest, Jessica Lakes, Cherry Grove Plantation, and neighborhoods near Coastal Carolina University. Call (843) 877-5539 for service throughout Horry County."
                    }
                  },
                  {
                    "@type": "Question",
                    "name": "How did recent storms affect Cherry Grove roofs?",
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "Tropical Storm Debby (August 2024) brought multiple days of heavy rain and flash flooding to Cherry Grove, causing water intrusion and drainage issues. Hurricane Helene (September 2024) had minimal direct impact but brought enhanced rainfall. We specialize in post-storm inspections and insurance claims."
                    }
                  }
                ]
              },
              {
                ...
                "itemListElement": [
                  ...
                  },
                  {
                    "@type": "ListItem",
                    "position": 3,
                    "name": "Cherry Grove Roofing",
                    "item": "https://weathershieldroofers.com/roofing/cherry-grove"
                  }
                ]
              }
            ]
      ...
      <main className="min-h-screen">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-6">
                ...
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
                  Cherry Grove's Trusted Roofing Experts
                </h1>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
              <div>
                ...
                <div className="text-sm text-gray-600">Cherry Grove Residents</div>
              </div>
              <div>
        ...
        {/* Why Choose Us for Cherry Grove */}
        <section className="py-16 md:py-24 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                <div className="inline-block bg-blue-100 text-blue-900 px-4 py-2 rounded-full text-sm font-semibold">
                  Why Cherry Grove Homeowners Choose Us
                </div>
                <h2 className="text-4xl md:text-5xl font-bold text-gray-900">
                  Understanding Cherry Grove's Unique Roofing Needs
                </h2>
                <div className="prose prose-lg text-gray-600">
                  <p>
                    Cherry Grove's inland location provides significant advantages over coastal properties, but your roof still faces unique challenges that require specialized expertise.
                  </p>
                  <p>
                    <strong>The Inland Advantage:</strong> Located 15 miles from the coast, Cherry Grove homes benefit from zero salt air corrosion on metal components like fasteners, flashing, and vents. This means your roof can last significantly longer than coastal properties.
                  </p>
                  <p>
                    <strong>Cherry Grove-Specific Challenges:</strong> However, Cherry Grove receives enhanced rainfall (53.7 inches annually) from sea-breeze front thunderstorms, experiences high humidity (74-78%) creating algae and mold growth, and faces tropical storm remnants bringing heavy rain and moderate winds.
                  </p>
                  <p>
                    As the county seat of Horry County and home to Coastal Carolina University, Cherry Grove's mix of historic properties downtown and newer suburban developments requires contractors who understand both traditional and modern roofing systems.
                  </p>
                </div>
              </div>
              <div className="relative">
                <div className="aspect-[4/3] relative rounded-2xl overflow-hidden shadow-2xl">
                  <Image
                    ...
                    alt="Professional roofing services in Cherry Grove SC near Coastal Carolina University"
                    fill
        ...
        {/* Cherry Grove Climate Challenges */}
        <section className="py-16 md:py-24 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
                Cherry Grove's Climate & Your Roof
              </h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Understanding how Cherry Grove's humid subtropical climate affects your roofing system
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg">
                ...
                <p className="text-gray-600 mb-4">Major advantage: Cherry Grove's inland location (15 miles from coast) eliminates salt spray corrosion on metal components.</p>
                <ul className="space-y-2">
                  <li className="flex items-start text-sm text-gray-700">
        ...
        <section className="py-16 md:py-24 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
                Complete Roofing Services for Cherry Grove
              </h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                From emergency repairs to complete replacements, serving all Cherry Grove neighborhoods
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                },
                {
                  ...
                  description: 'Tropical storm specialists. We handled Cherry Grove damage from Debby and Helene.',
                  icon: '⛈️',
                ...
                },
                {
                  ...
                  description: 'Expert restoration for downtown Cherry Grove historic properties and landmarks.',
                  icon: '🏛️',
                  link: '/services/roof-repair'
                },
                {
                  title: 'Gutter Services',
                  description: 'Critical for Cherry Grove\'s 53.7 inches annual rainfall. Installation, repair, guards.',
                  icon: '💧',
                ...
                },
                {
                  ...
                  description: 'Algae-resistant shingles and treatments for Cherry Grove\'s high humidity climate.',
                  icon: '🛡️',
        ...
        <section className="py-16 md:py-24 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
                Serving All Cherry Grove Neighborhoods
              </h2>
              <p className="text-xl text-gray-600">
                From historic downtown to Coastal Carolina University area, we protect Cherry Grove homes
              </p>
            </div>

            <div className="grid md:grid-cols-3 lg:grid-cols-5 gap-4">
              {[
                { name: 'Historic Downtown', link: '/locations/cherry-grove' },
                { name: 'Riverfront (Waccamaw)', link: '/locations/cherry-grove' },
                { name: 'Carolina Forest', link: '/locations/carolina-forest' },
                { name: 'Jessica Lakes', link: '/locations/cherry-grove' },
                { name: 'Cherry Grove Plantation', link: '/locations/cherry-grove' },
                { name: 'Glenmoor', link: '/locations/cherry-grove' },
                { name: 'Hillsborough', link: '/locations/cherry-grove' },
                { name: 'CCU Campus Area', link: '/locations/cherry-grove' },
                { name: 'Lake Busbee', link: '/locations/cherry-grove' },
                { name: 'Cherry Grove Riverwalk', link: '/locations/cherry-grove' }
            ...
            <div className="text-center mt-8">
              <Link href="/locations/cherry-grove" className="text-blue-600 hover:text-blue-700 font-semibold">
                View Complete Cherry Grove Service Map →
              </Link>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 md:py-24 bg-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
                Cherry Grove Roofing FAQs
              </h2>
              <p className="text-xl text-gray-600">
                Answers to common questions from Cherry Grove homeowners
              </p>
            </div>
            ...
            <div className="space-y-6">
              {[
                {
                  question: 'How does Cherry Grove\'s inland location affect my roof?',
                  answer: 'Cherry Grove\'s inland location (15 miles from the coast) provides significant advantages: no salt air corrosion on metal components, reduced wind speeds during storms, and longer roof lifespan. However, high humidity (74-78%) and heavy summer rainfall (53.7 inches annually) still require proper ventilation and moisture-resistant materials.'
                },
                {
                  question: 'What roofing challenges are specific to Cherry Grove SC?',
                  answer: 'Cherry Grove faces unique challenges: enhanced rainfall from sea-breeze front thunderstorms, high humidity creating algae and mold growth, tropical storm remnants bringing heavy rain, and intense summer UV exposure accelerating shingle deterioration. We use materials designed for these specific conditions.'
                },
                {
                  question: 'How did recent storms affect Cherry Grove roofs?',
                  answer: 'Tropical Storm Debby (August 2024) brought multiple days of heavy rain and flash flooding to Cherry Grove, causing water intrusion and drainage issues. Hurricane Helene (September 2024) had minimal direct impact but brought enhanced rainfall. We specialize in post-storm inspections and insurance claims.'
                },
                {
                  question: 'Do you work on historic properties in downtown Cherry Grove?',
                  answer: 'Absolutely! We have extensive experience with Cherry Grove\'s historic downtown buildings, including properties on the National Register. Our team understands preservation requirements and works to maintain architectural integrity while upgrading protection.'
                },
                {
                  question: 'How long does a roof last in Cherry Grove compared to coastal areas?',
                  answer: 'Cherry Grove roofs typically last 5-7 years longer than coastal properties due to the absence of salt air corrosion. Architectural shingles can last 30-35 years in Cherry Grove versus 25-28 years at the beach. Proper installation and maintenance maximize this advantage.'
                },
                {
                  question: 'What\'s the best roofing material for Cherry Grove\'s climate?',
                  answer: 'For Cherry Grove, we recommend GAF architectural shingles with algae resistance (high humidity), proper ventilation for heat/moisture, and wind ratings for tropical storms. Metal roofing is also excellent for Cherry Grove\'s inland conditions with minimal salt exposure.'
                },
                {
                  question: 'Do you serve the Coastal Carolina University area?',
                  answer: 'Yes! We serve all of Cherry Grove including the CCU campus area, student housing, and faculty residences. We work with property managers and homeowners to schedule around academic calendars when needed.'
                },
                {
                  question: 'How quickly can you respond to emergencies in Cherry Grove?',
                  answer: 'We provide rapid emergency response throughout Horry County. For Cherry Grove emergencies, we typically arrive within 1-2 hours. Call (843) 877-5539 anytime—real people answer 24/7, not an answering service.'
                },
                {
                  question: 'Do you handle insurance claims for storm damage?',
                  answer: 'Yes! We specialize in insurance claims for Cherry Grove storm damage. We document everything, work directly with adjusters, and handle the entire process from initial inspection through final payment. We helped many Cherry Grove homeowners after Tropical Storm Debby.'
                },
                {
                  question: 'What areas around Cherry Grove do you serve?',
                  answer: 'We serve all of Cherry Grove and surrounding Horry County including Carolina Forest, Aynor, Loris, Socastee, and areas toward Myrtle Beach (15 minutes away). We\'re your local Horry County roofing experts.'
                }
              ].map((faq, index) => (
        ...
        <section className="py-16 md:py-24 bg-gradient-to-br from-blue-900 via-blue-800 to-blue-900 text-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              Ready to Protect Your Cherry Grove Home?
            </h2>
            <p className="text-xl text-blue-100 mb-8">
              Join hundreds of Cherry Grove homeowners who chose quality, reliability, and local expertise with Weather Shield Roofing.
            </p>
            ...
            <p className="text-sm text-blue-100 mt-8">
              ⚡ Serving Cherry Grove, Coastal Carolina University, Carolina Forest, and all Horry County • Licensed & insured
            </p>
          </div>
        </section>
      </main>
